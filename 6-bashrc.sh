...
###tecplot
export TEC_HOME=/home/ljl/Apps/tecplot/360ex_2017r3
export CHORUS_HOME=/home/ljl/Apps/tecplot/chorus_2017r3
export PATH=$TEC_HOME/bin:$CHORUS_HOME/bin:$PATH
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/TEC_HOME/bin/mesa
